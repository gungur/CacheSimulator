...
// Main File:        csim.c
// This File:        csim.c
// Other Files:      Makefile, traces, csim-ref, test-csim 
...
//                   Track all work you do in your work log-p4b.pdf
...
void init_cache() {
	...
	cache = cache_t;
	cache_t = malloc(S * sizeof(cache_set_t));
	cache_set_t = malloc(E * sizeof(cache_line_t));
